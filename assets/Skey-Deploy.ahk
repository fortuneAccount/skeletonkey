...
if ((srcfn = "assets")or(srcfn = "bin")or(srcfn = "binaries"))
	{
		home= %srcpth%
	}	
binhome= %home%\bin
...
iniread,UPDTFILE,%home%\assets\arcorg.set,REPOSITORIES,originalBinary
...
iniread,UPDTURL,%home%\assets\arcorg.set,GLOBAL,Version
...
iniread,UPDTURL,%SKELD%\assets\arcorg.set,GLOBAL,Version
if ((UPDTURL = "ERROR")or(UPDTFILE = ""))
	{
		UPDTURL= https://raw.githubusercontent.com/%GITUSER%/%RJPRJCT%/master/site/version.txt
	}
...
Loop,parse,BLDITEMS,|
	{
		BLIT= %A_LoopField%
		iniread,nwurl,%SKELD%\assets\BuildTools.set,BUILDENV,%BLIT%
		%dwnlsi%URL= %nwurl%
...
iniwrite,%RJPRJCT%,%home%\skopt.cfg,GLOBAL,RJPRJCT	
iniread,UPDTFILE,%SKELD%\assets\arcorg.set,REPOSITORIES,originalBinary
if ((UPDTFILE = "ERROR")or(UPDTFILE = ""))
	{
		UPDTFILE= %GITSWEB%/%GITUSER%/%RJPRJCT%/releases/download/portable/portable.zip			
	}
...
DwnRls:
gui,submit,nohide
iniread,GRLURL,%SKELD%\assets\BuildTools.set,BUILDENV,Github_Release_%ARCH%
...
gui,submit,nohide
GetNSIS:
iniread,nsisurl,%SKELD%\assets\BuildTools.set,BUILDENV,NSIS
...
DwnSCI:
iniread,SCIURL,%SKELD%\assets\BuildTools.set,BUILDENV,SciTE4AutoHotkey
...
iniread,gitzurl,%SKELD%\assets\BuildTools.set,BUILDENV,GIT_%ARCH%
...
iniread,AHKURL,%SKELD%\assets\BuildTools.set,BUILDENV,AutoHotkey
...
Loop,%BUILDIT%\assets\SkDeploy.set
	{
		bldexists= 1
	}
if (bldexists = 1)
	{
		BUILDIR:= BUILDIT
		iniwrite, %BUILDIR%,%home%\skopt.cfg,GLOBAL,BUILDIR
		FileRead, nsiv,%BUILDIR%\assets\SkDeploy.set
...
if (IALTH = "")
	{
		iniread,IALTHv,%SKELD%\assets\arcorg.set,GLOBAL,IALTH
...
gui,submit,nohide
guicontrolget,HOSTINGURL,,HOSTINGURL
iniread,HOSTINGURLv,%SKELD%\assets\arcorg.set,GLOBAL,HOSTINGURL
if (HOSTINGURL = "")
	{
		if (GITUSER = "")
			{
...
HOSTINGURL= 
UPDTFILE= %GITSWEB%/%GITUSER%/%RJPRJCT%/releases/download/nodats
if (REPORURLT = "")
	{
		iniread,HOSTINGURLT,%SKELD%\assets\arcorg.set,GLOBAL,HOSTINGURL
...
FileRead,readme,%SKELD%\assets\ReadMe.set
...
arcorgv= 
FileMove,%SKELD%\assets\themes.set, %SKELD%\themes.bak,1
FileMove,%SKELD%\assets\arcorg.set, %SKELD%\arcorg.bak,1
FIleRead,skthemes,%SKELD%\assets\Themes.put
FIleRead,arcorgv,%SKELD%\assets\arcorg.put
		...
		Loop, files,%BUILDIR%\gam\*,D
			{
				...
				iniwrite,%REPOROOT%,%SKELD%\assets\arcorg.set,SOURCES,%REPONM%
				stringupper,UPARCNM,REPONM
				iniwrite,%GITSWEB%/%gituser%/%repodnm%/releases/download/%UPARCNM%/%A_LoopFileName%.7z,%SKELD%\assets\arcorg.set,SOURCES,%REPONM%:SET
...
iniread,arcsgg,%SKELD%\assets\arcorg.set,GLOBAL
Loop,parse,arcsgg,`r`n
	{
		if (A_LoopField = "")
			{
...
FileAppend,%arcorgv%,%SKELD%\assets\arcorg.set
FileAppend,%skthemes%,%SKELD%\assets\themes.set

FileDelete, %SKELD%\bin\%RJPRJCT%.exe
FileDelete, %SKELD%\assets\_working.ahk
sktmp= 
sktmc= 
sktmv= 
exrtc= |
...
FileRead, sktmp,%SKELD%\assets\working.ahk
...
stringreplace,sktmv,sktmv,`*`/  `;`;[DEBUGOV],,All
FileAppend,%sktmv%,%SKELD%\assets\_working.ahk

FileDelete, %SKELD%\bin\Update.exe
FileDelete,%SKELD%\assets\_Update.ahk
uptmp= 
uptmc= 
uptmv= 
FileRead, uptmp,%SKELD%\assets\Update.ahk
...
stringreplace,uptmv,uptmv,`*`/  `;`;[DEBUGOV],,All
FileAppend,%uptmv%,%SKELD%\assets\_Update.ahk


FileDelete, %SKELD%\bin\PortableUtil.exe
FileDelete,%SKELD%\assets\_PortableUtil.ahk
pbtmp= 
pbtmc= 
pbtmv= 
FileRead, pbtmp,%SKELD%\assets\PortableUtil.ahk
...
stringreplace,pbtmv,pbtmv,`*`/  `;`;[DEBUGOV],,All
FileAppend,%pbtmv%,%SKELD%\assets\_PortableUtil.ahk


FileDelete, %SKELD%\bin\init.exe
FileDelete,%SKELD%\assets\_init.ahk
intmp= 
intmc= 
intmv= 
FileRead, intmp,%SKELD%\assets\init.ahk
...
stringreplace,intmv,intmv,`*`/  `;`;[DEBUGOV],,All
FileAppend,%intmv%,%SKELD%\assets\_init.ahk
if (BCANC = 1)
	{
...
if (INITINCL = 1)
	{		
		...
		runwait, %comspec% /c " "%AHKDIR%\Ahk2Exe.exe" /in "%SKELD%\assets\_PortableUtil.ahk" /out "%SKELD%\bin\PortableUtil.exe" /icon "%SKELD%\img\helper.ico" /bin "%AHKDIR%\Unicode 32-bit.bin" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%	
		RunWait, %comspec% /c echo.##################  COMPILE UPDATER  ######################## >>"%DEPL%\deploy.log", ,%rntp%	
		runwait, %comspec% /c " "%AHKDIR%\Ahk2Exe.exe" /in "%SKELD%\assets\_Update.ahk" /out "%SKELD%\bin\Update.exe" /icon "%SKELD%\img\Update.ico" /bin "%AHKDIR%\Unicode 32-bit.bin" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%	
		RunWait, %comspec% /c echo.##################  COMPILE INITIALIZER  ######################## >>"%DEPL%\deploy.log", ,%rntp%	
		runwait, %comspec% /c " "%AHKDIR%\Ahk2Exe.exe" /in "%SKELD%\assets\_init.ahk" /out "%SKELD%\bin\Init.exe" /icon "%SKELD%\img\helper.ico" /bin "%AHKDIR%\Unicode 32-bit.bin" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%	
		RunWait, %comspec% /c echo.##################  COMPILE %RJPRJCT%  ######################## >>"%DEPL%\deploy.log", ,%rntp%	
		runwait, %comspec% /c " "%AHKDIR%\Ahk2Exe.exe" /in "%SKELD%\assets\_working.ahk" /out "%SKELD%\bin\%RJPRJCT%.exe" /icon "%SKELD%\site\key.ico" /bin "%AHKDIR%\Unicode 32-bit.bin" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%
		...
		if (isSrc <> 1)
			{
				...
				runwait, %comspec% /c " "%AHKDIR%\Ahk2Exe.exe" /in "%SKELD%\assets\Skey-Deploy.ahk" /out "%SKELD%\bin\Skey-Deploy.exe" /icon "%SKELD%\img\Sharp - X1.ico" /bin "%AHKDIR%\Unicode 32-bit.bin" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%
				RunWait, %comspec% /c echo.########################################## >>"%DEPL%\deploy.log", ,%rntp%
			}		
	}				
guicontrol,,progb,10
...
if (GitPush = 1)
	{
		...
		FileAppend, mkdir "%GITD%\assets"`n,%DEPL%\!gitupdate.cmd
		...
		FileAppend, copy /y "assets\*.bat" "%GITD%\assets"`n,%DEPL%\!gitupdate.cmd
		FileAppend, copy /y "bin\*.txt" "%GITD%\bin"`n,%DEPL%\!gitupdate.cmd
		FileAppend, copy /y "assets\*.ahk" "%GITD%\assets"`n,%DEPL%\!gitupdate.cmd
		...
		FileAppend, copy /y "assets\*.put" "%GITD%\assets"`n,%DEPL%\!gitupdate.cmd
		guicontrol,,progb,20
	}
if (BCANC = 1)
	{
...
if (IMGBLD = 1)
	{
		...
		GRARDT= %RAWGIT%/%GITUSER%/IMGDATS/master
...
if (ServerPush = 1)
	{
		...
		if (OvrStable = 1)
			{				
				...
				StringReplace,skelhtml,skelhtml,[REVISION],%GITSWEB%/%gituser%/%RJPRJCT%/releases/download/Installer/Installer.zip,All
				...
				ifnotexist, %SITEDIR%
					{
						FileCreateDir,%SITEDIR%
						FileCreateDir,%SITEDIR%\img						
						FileCopy,%SKELD%\site\*.html,%SITEDIR%,1		
						FileCopy,%SKELD%\site\*.ico,%SITEDIR%,1			
						FileCopy,%SKELD%\site\*.otf,%SITEDIR%,1			
						FileCopy,%SKELD%\site\*.ttf,%SITEDIR%,1			
						FileCopy,%SKELD%\site\*.md,%SITEDIR%,1			
						FileCopy,%SKELD%\site\img\*.png,%SITEDIR%\img,1
						FileCopy,%SKELD%\site\img\*.ico,%SITEDIR%\img,1
						FileCopy,%SKELD%\site\img\*.svg,%SITEDIR%\img,
					}
		...
		if (GitPush = 1)
			{	
				...
				fileappend,git config --global --add safe.directory "%GITD%"`n,%DEPL%\gpush.cmd
		...
		if (SiteUpdate = 1)
			{
				...
				FileAppend,git config --global --add safe.directory "%SITEDIR%"`n,%DEPL%\gpush.cmd
		...
		if (REPOBLD = 1)
			{
				...
				fileappend,if not exist ".git\" cd ..\ && git -C "%REPODATL%" init && cd "%REPODATL%"`n,%DEPL%\gpush.cmd
				FileAppend,git config --local credential.helper wincred`n,%DEPL%\gpush.cmd
				fileappend,git config --local user.name %GITUSER%`n,%DEPL%\gpush.cmd
				fileappend,git config --local user.email %GITMAIL%`n,%DEPL%\gpush.cmd
				fileappend,gh config set git_protocol https`n,%DEPL%\gpush.cmd
		...
		if (DATBLD = 1)
			{
				...
				fileappend,if not exist ".git\" cd ..\ && git -C "%ROMDATL%" init && cd "%ROMDATL%"`n,%DEPL%\gpush.cmd
				FileAppend,git config --local credential.helper wincred`n,%DEPL%\gpush.cmd
				fileappend,git config --local user.name %GITUSER%`n,%DEPL%\gpush.cmd
				fileappend,git config --local user.email %GITMAIL%`n,%DEPL%\gpush.cmd
				fileappend,gh config set git_protocol https`n,%DEPL%\gpush.cmd
		...
		if (IMGBLD = 1)
			{
				...
				fileappend,git config --local user.name %GITUSER%`n,%DEPL%\gpush.cmd
				fileappend,git config --local user.email %GITMAIL%`n,%DEPL%\gpush.cmd
				fileappend,if not exist ".git\" cd ..\ && git -C "%IMGDATL%" init && cd "%IMGDATL%"`n,%DEPL%\gpush.cmd
				fileappend,gh config set git_protocol https`n,%DEPL%\gpush.cmd
				fileappend,gh auth login -w --scopes repo`,delete_repo`n,%DEPL%\gpush.cmd
				FileAppend,gh repo create %IMGDNM% --public --source="%IMGDATL%"`n,%DEPL%\gpush.cmd
				FileAppend,git config --global --add safe.directory "%IMGDATL%"`n,%DEPL%\gpush.cmd
				FileAppend,git add .`n,%DEPL%\gpush.cmd
				fileappend,git remote add %IMGDNM% %GITSWEB%/%GITUSER%/%IMGDNM%`n,%DEPL%\gpush.cmd		
				FileAppend,git commit -a -m "%PUSHNOTES%"`n,%DEPL%\gpush.cmd
...
if (PortVer = 1)
	{		
		...
		runwait, %comspec% /c " "%BUILDIR%\bin\7za.exe" a -tzip "%DEPL%\portable.zip" -r bin\*.exe bin\*.sfx bin\*.txt bin\*.sfx bin\*.bat assets\*.ahk assets\*.txt assets\*.put rj\*.set rj\*.get rj\*.ret rj\*.xpadderprofile rj\*.amgp site\*.png site\*.ico site\*.txt site\*.otf site\*.ttf site\*.html site\*.md -w"%A_Temp%" >>"%DEPL%\deploy.log"", %SKELD%,%rntp%					
		sleep, 1000
		RunWait, %comspec% /c echo.########################################## >>"%DEPL%\deploy.log", ,%rntp%	
	}	
		...
		Loop, Files, %BUILDIR%\dats\*,D
			{
				FileCreateDir,%ROMDATL%\%A_LoopFileName%
				FileCopy,%A_LoopFileLongPath%\*.*,%ROMDATL%\%A_LoopFileName%,1
				FileMove,%DEPL%\%romdnm%\%A_LoopFileName%.zip,%DEPL%\%romdnm%\%A_LoopFileName%.old,1
				runwait, %comspec% /c " "%BUILDIR%\bin\7za.exe" a -tzip "%DEPL%\%romdnm%\%A_LoopFileName%.zip" -r "%A_LoopFileName%\*" >>"%DEPL%\deploy.log"",%ROMDATL%,%rntp%
				FileCopy,%ROMDATL%\%A_LoopFileName%.zip,%DEPL%\%ROMDATL%\%A_LoopFileName%.zip,1
				datlsts.= DEPL . "\" . romdnm . "\" . A_LoopFileName . ".zip" . "|"
			}	
		RunWait, %comspec% /c echo.########################################## >>"%DEPL%\deploy.log", ,%rntp%
...
if (REPOBLD = 1)
	{		
		...
		Loop,Files %BUILDIR%\gam\*,D
			{
				FileCreateDir,%REPODATL%\%A_LoopFileName%
				FileMove,%DEPL%\%repdnm%\%A_LoopFileName%.7z,%DEPL%\%repdnm%\%A_LoopFileName%.old,1
				FileCopy,%A_LoopFileLongPath%\*.*,%REPODATL%\%A_LoopFileName%,1
				runwait, %comspec% /c " "%BUILDIR%\bin\7za.exe" a -t7z "%DEPL%\%repdnm%\%A_LoopFileName%.7z" * >>"%DEPL%\deploy.log"",%REPODATL%\%A_LoopFileName%,%rntp%
				FileCopy,%REPODATL%\%A_LoopFileName%.7z,%DEPL%\%repodnm%\%A_LoopFileName%.7z,1
				repolsts.= DEPL . "\" . repodnm . "\" . A_LoopFileName . ".7z" . "|"
			}	
		RunWait, %comspec% /c echo.########################################## >>"%DEPL%\deploy.log", ,%rntp%
	}
return
